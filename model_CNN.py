...
path1 = 'E:/banana Leaf disease detection/banana Leaf disease detection/traning/0'    #path of folder of images    
path2 = 'E:/banana Leaf disease detection/banana Leaf disease detection/traning_set/0'  #path of folder to save images    
